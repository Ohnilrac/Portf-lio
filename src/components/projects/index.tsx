    ...
    <Container>
      <div>
        ...
        <div>
          ...
          <a href="" target="_blank">Link do projeto no github</a>
          <a href="" target="_blank">Link do projeto na web</a>
        </div>
        <div>
          <div>...</div>
          <img src="" alt="" />
        ...
        <div>
          ...
          <a href="https://github.com/Ohnilrac/estetica_capilar" target="_blank">Link do projeto no github</a>
          <a href="https://ohnilrac.github.io/estetica_capilar/" target="_blank">Link do projeto na web</a>
        </div>
      </div>
    </Container>
  )
